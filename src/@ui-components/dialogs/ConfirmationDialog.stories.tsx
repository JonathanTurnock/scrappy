...
import { fdConfirm, FdConfirmationDialog, IConfirmationDialog } from "./FdConfirmationDialog"
...
export default {
  title: "AsyncDialogs/Confirm",
  component: FdConfirmationDialog,
} as Meta

const Template: Story<IConfirmationDialog & AwaitableDialogProps<boolean>> = (args) => (
  <FdConfirmationDialog {...args} />
)
